...
def generate_final_config():
    ...
    if os.path.exists('ruleset/hiddify/'):
        for folder, is_block in [('ruleset/hiddify/', False), ('ruleset/hiddify/block/', True)]:
    ...
    with open('hiddify_config.json', 'w', encoding='utf-8') as f:
        f.write(header)
        json.dump(config, f, indent=2, ensure_ascii=False)

    print("\nhiddify_config.json успешно сохранён.")
